...
namespace uS
{
    ...
    Node::Node(int recvLength, int prePadding, int postPadding, bool useDefaultLoop, Loop *loopOverride)
    {
        ...
        loop = loopOverride ? loopOverride : Loop::createLoop(useDefaultLoop);
